(() => {
  ...
  (() => {
    ...
    const playernameEl = document.querySelector('#inputPlayerName');
    ...
    playernameEl.addEventListener('keypress', submitAction);
    rawPasswordEl.addEventListener('keypress', submitAction);
    repeatPasswordEl.addEventListener('keypress', submitAction);
    captchaCodeEl.addEventListener('keypress', submitAction);
  })();
